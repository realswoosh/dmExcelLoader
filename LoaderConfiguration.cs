...
namespace dmExcelLoader
{
	public class LoaderConfiguration
	{
		...
		*/
		...
		public string PathBinary { get; set; } = "OutputBinary";
		...
		public string PathOutputClass { get; set; } = "OutputResource";
		public string PathOutputClassResourceManager { get; set; } = "OutputResourceManager";

		public string PathOutputBinary { get; set; } = "OutputBinary";
